...
public class SelectDataSourceController {
    ...
    private final File workingFolder = new File(System.getProperty("user.dir"), "target");

    private final Map<DataServiceProperty, SimpleStringProperty> dataServicePropertyStringMap = new HashMap<>();
